<div class="container">
                         ...
                         <div class="col-lg-3 col-md-4 col-6">
                             <div class="product">
                                 <div class="product_img">
                                     <a href="#"><img src="popular-product1.jpg" alt="product_img1"></a>
                                 </div>
                                 <div class="product_info">
                                     <h6 class="product_title"><a href="/details?id=1">Product 1</a></h6>
                                     <div class="product_price"><span class="price">$ 99</span></div>
                                 </div>
                             </div>
                         </div>
                 ...
                 <div class="tab-pane fade" id="New" role="tabpanel" aria-labelledby="sellers-tab">
                     <div id="NewItem" class="row shop_container">
                         <div class="col-lg-3 col-md-4 col-6">
                             <div class="product">
                                 <div class="product_img">
                                     <a href="#"><img src="new-product1.jpg" alt="product_img1"></a>
                                 </div>
                                 <div class="product_info">
                                     <h6 class="product_title"><a href="/details?id=2">Product 2</a></h6>
                                     <div class="product_price"><span class="price">$ 150</span></div>
                                 </div>
                             </div>
                         </div>
                         <!-- Add more static products here -->
                 ...
                 <div class="tab-pane fade" id="Top" role="tabpanel" aria-labelledby="featured-tab">
                     <div id="TopItem" class="row shop_container">
                         <div class="col-lg-3 col-md-4 col-6">
                             <div class="product">
                                 <div class="product_img">
                                     <a href="#"><img src="top-product1.jpg" alt="product_img1"></a>
                                 </div>
                                 <div class="product_info">
                                     <h6 class="product_title"><a href="/details?id=3">Product 3</a></h6>
                                     <div class="product_price"><span class="price">$ 200</span></div>
                                 </div>
                             </div>
                         </div>
                         <!-- Add more static products here -->
                 ...
                 <div class="tab-pane fade" id="Special" role="tabpanel" aria-labelledby="special-tab">
                     <div id="SpecialItem" class="row shop_container">
                         <div class="col-lg-3 col-md-4 col-6">
                             <div class="product">
                                 <div class="product_img">
                                     <a href="#"><img src="special-product1.jpg" alt="product_img1"></a>
                                 </div>
                                 <div class="product_info">
                                     <h6 class="product_title"><a href="/details?id=4">Product 4</a></h6>
                                     <div class="product_price"><span class="price">$ 250</span></div>
                                 </div>
                             </div>
                         </div>
                         <!-- Add more static products here -->
                 ...
                 <div class="tab-pane fade" id="Trending" role="tabpanel" aria-labelledby="special-tab">
                     <div id="TrendingItem" class="row shop_container">
                         <div class="col-lg-3 col-md-4 col-6">
                             <div class="product">
                                 <div class="product_img">
                                     <a href="#"><img src="trending-product1.jpg" alt="product_img1"></a>
                                 </div>
                                 <div class="product_info">
                                     <h6 class="product_title"><a href="/details?id=5">Product 5</a></h6>
                                     <div class="product_price"><span class="price">$ 300</span></div>
                                 </div>
                             </div>
                         </div>
                         <!-- Add more static products here -->
 ...
 <!-- Removed the JavaScript/AJAX part -->
